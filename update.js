...
const updateOptions = {
  ...
  gitUsername: "FienexSistorm",  // [Required] Your GitHub Username.
  ...
  appName: "electron-demo", //[Required] The Name of the app archive and the app folder.
  appExecutableName: "electron-demo.exe", //[Required] The Executable of the Application to be Run after updating.
